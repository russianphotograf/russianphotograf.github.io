...
// Pano2VR 5.0/12110
// Filename: ?????? ?????????? (?? ?????).ggsk
// Generated Ср апр 12 22:01:48 2017
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._fullscreen_off.ggLeft=65;
		this._fullscreen_off.ggTop=-41;
		...
		this._autorotate.ggLeft=-1;
		this._autorotate.ggTop=-41;
		...
		this._autorotate_off.ggLeft=-1;
		this._autorotate_off.ggTop=-41;
		...
		this._zoomout.ggLeft=-35;
		this._zoomout.ggTop=-41;
		...
		this._zoomin.ggLeft=-67;
		this._zoomin.ggTop=-41;
		...
		this._userdata.appendChild(this._screentint);
		...
		this._container_1.appendChild(this._author);
		this._ht_info_close0=document.createElement('div');
		this._ht_info_close0__img=document.createElement('img');
		this._ht_info_close0__img.className='ggskin ggskin_svg';
		this._ht_info_close0__img.setAttribute('src',basePath + 'images/ht_info_close0.svg');
		this._ht_info_close0__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;');
		this._ht_info_close0__img['ondragstart']=function() { return false; };
		this._ht_info_close0.appendChild(this._ht_info_close0__img);
		this._ht_info_close0.ggId="ht_info_close";
		this._ht_info_close0.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._ht_info_close0.ggVisible=true;
		this._ht_info_close0.className='ggskin ggskin_svg ';
		this._ht_info_close0.ggType='svg';
		hs ='';
		hs+='cursor : pointer;';
		hs+='height : 32px;';
		hs+='left : 197px;';
		...
		hs+='visibility : inherit;';
		hs+='width : 32px;';
		this._ht_info_close0.setAttribute('style',hs);
		this._ht_info_close0.style[domTransform + 'Origin']='50% 50%';
		...
		me._ht_info_close0.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._ht_info_close0.onclick=function () {
		...
		this._ht_info_close0.ggUpdatePosition=function () {
		}
		this._container_1.appendChild(this._ht_info_close0);
		this._userdata.appendChild(this._container_1);
